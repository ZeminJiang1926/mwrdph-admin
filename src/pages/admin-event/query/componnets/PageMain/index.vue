   ...
   -->
      <el-table-column label="路段">
        <template slot-scope="scope">
          <el-tag size="mini" type="success">{{scope.row.section_id}}</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="审查员" width="85">
        <template slot-scope="scope">{{scope.row.admin}}</template>
      </el-table-column>

      <el-table-column label="管理员批注" width="250" show-overflow-tooltip>
        <template slot-scope="scope">  <el-tag size="mini" type="info">{{scope.row.info}}</el-tag></template>
      </el-table-column>
